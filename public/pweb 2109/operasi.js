function tambah()
{
    ...
    var bilangan2= parseInt(document.getElementById("bil2").value); //method mengembalikan value
...
function kali()
{
    ...
    var bilangan2= document.getElementById("bil2").value; //method mengembalikan value
    var hasilnya= document.getElementById("hasil"); //returnnya object
