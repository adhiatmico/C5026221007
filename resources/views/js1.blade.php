...
<head>
  ...
  <script>
    ...
    function changeText() {
            ...
            textBox.style.color = "red";  //mengubah warna font dari text box jd merah
            span.innerHTML = textBox.value;
            //innerHTML mengubah text ssecara runtime
            // .value = membaca isi komponen form
            console.log("Horee sudah disini")
            console.log("Isiya text box adalah" + textBox.value)
}

 </script>

<script src="{{asset('pweb 2109/operasi.js')}}"></script>
</head>
<body>
<div class="container">
    <center><button class="btn btn-primary" onclick="showalert();">Klik disini !</button></center>
    <br>
    <button onclick="changeText();" class="btn btn-secondary">Click me!</button>
